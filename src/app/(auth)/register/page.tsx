...
import { registerAction, loginWithGoogleAction } from "@/lib/actions/auth.actions";
      ...
      >
        ...
        <Card className="border-border/60 shadow-xl">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardDescription>Mulai belajar bahasa Jepang jadi lebih mudah & menyenangkan</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            >
              <svg className="h-4 w-4" viewBox="0 0 24 24">
                ...
                <path fill="#FBBC05" d="M5.84 14.14c-.22-.69-.35-1.43-.35-2.14s.13-1.45.35-2.14V7.02H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.98l3.66-2.84z" />
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="fullName" placeholder="Nama Lengkap" className="pl-9" {...register("fullName")} />
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="email" type="email" placeholder="nama@email.com" className="pl-9" {...register("email")} />
                </div>
